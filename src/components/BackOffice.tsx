        ...
        <div className="overflow-x-auto">
          <table className="w-full border border-gray-300 rounded-lg shadow-md overflow-hidden">
            <thead className="bg-gradient-to-r from-gray-200 to-gray-300 text-gray-700 uppercase text-xs md:text-sm font-bold">
              <tr>
                <th className="p-2 md:p-4 text-left border border-gray-300">Imagen</th>
                <th className="p-2 md:p-4 text-left border border-gray-300">Nombre</th>
                <th className="p-2 md:p-4 text-left border border-gray-300">Precio</th>
                <th className="p-2 md:p-4 text-left border border-gray-300">Cantidad</th>
                <th className="p-2 md:p-4 text-left border border-gray-300">Acciones</th>
              </tr>
            </thead>
            <tbody className="bg-white divide-y divide-gray-200">
              {cart.map((pizza) => (
                <tr key={pizza._id} className="hover:bg-gray-50 transition-all duration-200">
